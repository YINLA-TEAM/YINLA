      ...
      async function () {
        try {
          const eqResult = await axios.get(
            `https://opendata.cwa.gov.tw/api/v1/rest/datastore/E-A0016-001?Authorization=${process.env.cwa_key}`
          );
