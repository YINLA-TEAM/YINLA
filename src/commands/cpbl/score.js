...
const fetchCPBLScore = async() => {
    ...
    game_detail.forEach((game) => {
        gameArray.push({
            ...
            away_sp_cnt: game?.VisitingFirstAcnt,
            home_sp_name: game?.HomeFirstMover,
            home_sp_cnt: game?.HomeFirstAcnt,
            ...
            hitter_cnt: game?.CurtBatting?.HitterAcnt,
            ...
            pitcher_cnt: game?.CurtBatting?.PitcherAcnt,
            ...
            loses_pitcher_cnt: game?.LosePitcherAcnt,
                ...
                switch (game[i].gameStatus) {
                    case 1:
                        ...
                        const ifNeededGame_Embed = new EmbedBuilder()
                            ...
                            .addFields([
                                { name: "客隊先發投手", value: game[i].away_sp_cnt == '' ? "未公布" : `${teamIcon(game[i].awayTeam_code)} [${game[i].away_sp_name}](https://www.cpbl.com.tw/team/person?acnt=${game[i].away_sp_cnt})`, inline: true },
                                { name: "主隊先發投手", value: game[i].home_sp_cnt == '' ? "未公布" : `${teamIcon(game[i].homeTeam_code)} [${game[i].home_sp_name}](https://www.cpbl.com.tw/team/person?acnt=${game[i].home_sp_cnt})`, inline: true },
                    ...
                    case 2:
                        ...
                        const playBall_Embed = new EmbedBuilder()
                            ...
                            .setColor('Green')
                            .addFields([
                                { name: "投手", value: `${teamIcon(game[i].pitcher_team)} [${game[i].pitcher_no + " " + game[i].pitcher_name}](https://www.cpbl.com.tw/team/person?acnt=${game[i].pitcher_cnt})`, inline: true },
                                { name: "** **", value: "** **", inline: true },
                                { name: "打者", value: `${teamIcon(game[i].hitter_team)} [${game[i].hitter_no + " " + game[i].hitter_name}](https://www.cpbl.com.tw/team/person?acnt=${game[i].hitter_cnt})`, inline: true },
                    ...
                    case 3:
                        ...
                        const endGame_Embed = new EmbedBuilder()
                            ...
                            .setColor('Red')
                            .addFields([
                                { name: "勝投", value: game[i].wins_pitcher_name == '' ? "無" : `${teamIcon(game[i].wins_pitcher_team)} [${game[i].wins_pitcher_name}](https://www.cpbl.com.tw/team/person?acnt=${game[i].wins_pitcher_cnt})`, inline: true },
                                { name: "敗投", value: game[i].loses_pitcher_name == '' ? "無" : `${teamIcon(game[i].loses_pitcher_team)} [${game[i].loses_pitcher_name}](https://www.cpbl.com.tw/team/person?acnt=${game[i].loses_pitcher_cnt})`, inline: true },
                                { name: "** **", value: "** **", inline: true },
                                { name: "客隊勝敗和", value: `${game[i].awayTeam_W}-${game[i].awayTeam_L}-${game[i].awayTeam_T}`, inline: true },
                                { name: "主隊勝敗和", value: `${game[i].homeTeam_W}-${game[i].homeTeam_L}-${game[i].homeTeam_T}`, inline: true },
                            ])
