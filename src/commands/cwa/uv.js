...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const uvResult = await axios.get(
      `https://opendata.cwa.gov.tw/api/v1/rest/datastore/O-A0003-001?Authorization=${process.env.cwa_key}&format=JSON`
    );
    ...
    function getUV(StationName) {
      return clearedData.find((Station) => Station.StationName === StationName)
        .UVIndex;
    }
    /* AirTemperature */
